...
public class Tools {
    ...
    public static Bitmap getFoto(ResponseBody body, String codFuncionario, Context context) {
        ...
        try {
            ...
            try {
                in = body.byteStream();
                out = new FileOutputStream(context.getExternalFilesDir(null) + File.separator + codFuncionario + ".jpg");
                int c;
            ...
            Bitmap bitmap = BitmapFactory.decodeFile(context.getExternalFilesDir(null) + File.separator + codFuncionario + ".jpg");

            if (bitmap != null && !"".equals(bitmap)) {
                return Bitmap.createScaledBitmap(bitmap, 90, 100, true);
            }
